-- Fix RLS Policies and ensure company_id columns exist
...
-- ============================================================================
-- STEP 4: Populate company_id where missing (for invoice_items)
-- ============================================================================
...
AND ii.invoice_id IN (SELECT id FROM invoices i);
